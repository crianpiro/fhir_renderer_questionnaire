import 'package:fhir_renderer_questionnaire_example/data/default_validation_mock.dart';
import 'package:fhir_renderer_questionnaire_example/data/questionnaires_mock.dart';
import 'package:fhir_renderer_questionnaire_example/data/regex_validation_mock.dart';
import 'package:fhir_renderer_questionnaire_example/views/custom_builder_examples.dart';
import 'package:fhir_renderer_questionnaire_example/views/focus_test_page.dart';
import 'package:fhir_renderer_questionnaire_example/views/questionnaire_example_page.dart';
import 'package:flutter/material.dart';

/// Landing page listing every fhir_renderer_questionnaire example.
///
/// This lives outside `main.dart` so that the monorepo-wide showcase app can
/// embed it next to the other packages' examples. Running this example on its
/// own still goes through `main.dart`, which wraps this page in a [MaterialApp].
